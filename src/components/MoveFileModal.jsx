...
export default function MoveFileModal(props) {
    ...
    return (
      <>
       <Dialog open={props.open} onClose={props.handleClose}>
        <DialogTitle>Move this file into the folder of your choice:</DialogTitle>
        <DialogContent>
        ...
        <DialogActions>
          ...
          <Button onClick={moveFile}>Move the file</Button>
        </DialogActions>
      </Dialog>
      </>
